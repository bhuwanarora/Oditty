module AuthorsHelper
	def self.get_active_authors skip_count 
		...
		find_active_author = " MATCH (author:Author :ActiveAuthor) WITH author ORDER BY author.priority DESC SKIP " + skip_count.to_s + " LIMIT " + Constant::Count::FollowFavoriteAuthors.to_s

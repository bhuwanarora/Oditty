homeApp.controller('homeController', ["$scope", "$rootScope", "$timeout", "$mdSidenav", "$log", '$q', '$mdBottomSheet', '$mdDialog', 'scroller', '$document', function($scope, $rootScope, $timeout, $mdSidenav, $log, $q, $mdBottomSheet, $mdDialog, scroller, $document){
    ...
    $scope.show_grid = function(event){
        if($scope.constant.show_book){
            ...
            // $scope._init();
            $scope.colorTiles = $scope.tempBooks;
        }
    }
    ...
    $scope.show_book = function(event, index){
        ...
        // alert(id);
        // var scrollTop = event.currentTarget.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.scrollTop;
        // var boundingRectangle = event.currentTarget.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.getBoundingClientRect();
        ...
        // debugger
        $scope.tempBooks = $scope.colorTiles;
        $scope.colorTiles = $scope.colorTiles.slice(0, insertIndex);
        // $scope.colorTiles.splice(insertIndex, 0, item);
        $scope.constant = {"show_book": true};
        event.stopPropagation();
        // console.log(bookBoundingRectangle.top)
        // console.debug(marginTop, event.currentTarget.parentElement.parentElement.clientY, event.currentTarget.parentElement.parentElement.parentElement.parentElement.parentElement.clientY, event.currentTarget.parentElement.parentElement.parentElement.parentElement.clientY, offsetTop);
        // debugger
        // scroller.scrollDelta(0, bookBoundingRectangle.top, duration);
        // scroller.scrollBy(0, 1000, duration);
    }

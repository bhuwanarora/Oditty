bookApp.directive('flipbook', function($rootScope, $timeout){
	return{
		...
		controller: function($scope){
			...
			$scope.on_discussions = function(){
				console.log("on_discussions");
			}
...
bookApp.directive('discussion', function(){
	return{
		...
		controller: function($scope){
			_init = function(){
				$scope.hovered = false;
				$('.discussion').on('mouseover', function(){
					console.log("addClass");
				})
			}

			$scope.show_nested_discussion_link = function(){
				console.log("show_nested_discussion_link");
			}

			$scope.show_nested_discussion = function(){
				console.log("show_nested_discussion");
			}

...
function MdAutocompleteCtrl ($scope, $element, $mdUtil, $mdConstant, $timeout, $mdTheming, $window,
  ...
  function init () {
    ...
    $mdTheming($element);
    console.log("configureWatchers INIT");
    configureWatchers();
    $timeout(function () {
      gatherElements();
      focusElement();
  ...
  function selectedItemChange (selectedItem, previousSelectedItem) {
    console.log("%c selectedItemChange" + (selectedItem == previousSelectedItem), 'background: #222; color: #bada55');
    if(selectedItem == previousSelectedItem){
        console.log("setting previousSelectedItem to NULL");
  ...
  function handleSelectedItemChange(selectedItem, previousSelectedItem) {
    // if((selectedItem == previousSelectedItem) && (previousSelectedItem != null)){

    // }
    // var execute_when = (selectedItem != null && previousSelectedItem != null) || ((selectedItem == previousSelectedItem) &&  (previousSelectedItem == null));
    // console.log("%c handleSelectedItemChange", 'background: #222; color: #bada55');
    // var execute_when = selectedItem != previousSelectedItem;
    // if(execute_when){
    // }
    console.table([{"selectedItem": selectedItem, "previousSelectedItem":previousSelectedItem, "selectedItemWatchers":selectedItemWatchers}]);
  ...
  function handleSearchText (searchText, previousSearchText) {
    ...
    if (!isMinLengthMet()) {
      ...
      var unregister = $scope.$watch(function(){
        if(itemExpr != "[]"){
          return $scope.$parent.$eval(itemExpr);
        }
  ...
  function select (index) {
    ...
    $timeout(function () {
      if(angular.isDefined(elements.$.input.controller('ngModel'))){
  ...
  function handleQuery () {
    ...
    // if (!$scope.noCache && cache[term] && term != "") {
      ...
      return '\
        <md-autocomplete-wrap\
          ...
          <ul role="presentation"\
              ...
              ng-hide="$mdAutocompleteCtrl.hidden || hideDropdown"\

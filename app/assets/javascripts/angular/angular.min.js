...
//PUBNUB
"use strict";angular.module("pubnub.angular.service",[]).factory("PubNub",function(e){var t,n,r,i,s;t={_instance:null,_channels:[],_presence:{},jsapi:{}};s=["map","each"];for(r=0,i=s.length;r<i;r++){n=s[r];if((typeof PUBNUB!=="undefined"&&PUBNUB!==null?PUBNUB[n]:void 0)instanceof Function){(function(e){return t[e]=function(){var n;return(n=t["_instance"])!=null?n[e].apply(t["_instance"],arguments):void 0}})(n)}}for(n in PUBNUB){if((typeof PUBNUB!=="undefined"&&PUBNUB!==null?PUBNUB[n]:void 0)instanceof Function){(function(e){return t["jsapi"][e]=function(){var n;return(n=t["_instance"])!=null?n[e].apply(t["_instance"],arguments):void 0}})(n)}}t.initialized=function(){return!!t["_instance"]};t.init=function(){t["_instance"]=PUBNUB.init.apply(PUBNUB,arguments);t["_channels"]=[];t["_presence"]={};return t["_instance"]};t.destroy=function(){t["_instance"]=null;t["_channels"]=null;return t["_presence"]=null};t._ngFireMessages=function(n){return function(r,i,s){return t.each(r[0],function(t){return e.$broadcast("pn-message:"+n,{message:t,channel:n})})}};t._ngInstallHandlers=function(n){var r,i;r=n.message;n.message=function(){e.$broadcast(t.ngMsgEv(n.channel),{message:arguments[0],env:arguments[1],channel:n.channel});if(r){return r(arguments)}};i=n.presence;n.presence=function(){var r,s,o,u;o=arguments[0];r=n.channel;if(o.uuids){t.each(o.uuids,function(e){var n;(n=t["_presence"])[r]||(n[r]=[]);if(t["_presence"][r].indexOf(e)<0){return t["_presence"][r].push(e)}})}else{if(o.uuid&&o.action){(u=t["_presence"])[r]||(u[r]=[]);if(o.action==="leave"){s=t["_presence"][r].indexOf(o.uuid);if(s!==-1){t["_presence"][r].splice(s,1)}}else{if(t["_presence"][r].indexOf(o.uuid)<0){t["_presence"][r].push(o.uuid)}}}}e.$broadcast(t.ngPrsEv(n.channel),{event:o,message:arguments[1],channel:r});if(i){return i(arguments)}};return n};t.ngListChannels=function(){return t["_channels"].slice(0)};t.ngListPresence=function(e){var n;return(n=t["_presence"][e])!=null?n.slice(0):void 0};t.ngSubscribe=function(e){var n,r;if(t["_channels"].indexOf(e.channel)<0){t["_channels"].push(e.channel)}(n=t["_presence"])[r=e.channel]||(n[r]=[]);e=t._ngInstallHandlers(e);return t.jsapi.subscribe(e)};t.ngUnsubscribe=function(n){var r;r=t["_channels"].indexOf(n.channel);if(r!==-1){t["_channels"].splice(r,1)}t["_presence"][n.channel]=null;delete e.$$listeners[t.ngMsgEv(n.channel)];delete e.$$listeners[t.ngPrsEv(n.channel)];return t.jsapi.unsubscribe(n)};t.ngPublish=function(){return t["_instance"]["publish"].apply(t["_instance"],arguments)};t.ngHistory=function(e){e.callback=t._ngFireMessages(e.channel);return t.jsapi.history(e)};t.ngHereNow=function(e){e=t._ngInstallHandlers(e);e.callback=e.presence;delete e.presence;delete e.message;return t.jsapi.here_now(e)};t.ngMsgEv=function(e){return"pn-message:"+e};t.ngPrsEv=function(e){return"pn-presence:"+e};t.ngAudit=function(){return t["_instance"]["audit"].apply(t["_instance"],arguments)};t.ngGrant=function(){return t["_instance"]["grant"].apply(t["_instance"],arguments)};return t})
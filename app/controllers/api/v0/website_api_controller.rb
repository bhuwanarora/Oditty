	...
	module V0
		class WebsiteApiController < ApplicationController
			...
			def trends
    			...
    			clause = "MATCH (t:Trending) WHERE t.status = 1 RETURN t.name, ID(t), t.content, t.url, t.title, t.thumb, t.thumbnail_url, t.publisher_thumb, t.searched_words, t.timestamp ORDER BY t.timestamp DESC SKIP "+skip_count.to_s+" LIMIT 4"
    			puts clause.blue.on_red

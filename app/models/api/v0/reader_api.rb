module Api
	module V0
		class ReaderApi
			def self.readermarked_readers
				# self.recommendations.map do |s|
				# 	s['readermark_status'] = 1
				# 	s
				# end
			end
			...
			def self.push_recommendations
				...
				test_reader = test_reader.merge(
					:thumb => {
						:url => "assets/readers/a2.jpeg",
			...
			def self.recommendations
				...
				test_reader1 = test_reader.merge(
					...
					:category => {:name => "Similar Reader", 
								:url => "javascript:void(0);", 
								:background_color => "#3cb878", 
								:description => "Similar Reader"},
					:id => 1)

				test_reader2 = test_reader.merge(
					:thumb => {
						:url => "assets/profile_pic.jpeg",
						:background_color => "#E9BC4B"},
					:category => {:name => "Must Follow", 
								:url => "javascript:void(0);", 
								:background_color => "#3cb878", 
				...
				test_reader3 = test_reader.merge(
					:thumb => {
						:url => "assets/profile_pic.jpeg",
						:background_color => "#F4EFE9"},
					:category => {:name => "Friend of Friend",
								:url => "javascript:void(0);", 
								:background_color => "#3cb878", 
								:description => "Highly rated book"},
					:id => 3)
				...
				test_reader4 = test_reader.merge(
					:thumb => {
						:url => "assets/profile_pic.jpeg",
						:background_color => "#55504C"},
					:category => {:name => "Popular Reader", 
								:url => "javascript:void(0);", 
								:background_color => "#3cb878", 
								:description => "Highly rated book"},
					:id => 4)
				...
				test_reader5 = test_reader.merge(
					:thumb => {
						:url => "assets/profile_pic.jpeg",
				...
				# count = params[:count]
				readers = [test_reader1, test_reader2, test_reader3, test_reader4, test_reader5]
			end

			def self.detailed_reader id
				if id == "1"
					thumb = "assets/readers/20.jpeg"
				elsif id == "2"
					thumb = "assets/readers/15.jpeg"
				elsif id == "3"
					thumb = "assets/readers/11.jpeg"
				elsif id == "4"
					thumb = "assets/readers/13.jpeg"
				elsif id == "5"
					thumb = "assets/readers/a2.jpeg"
				elsif id == "13"
					thumb = "assets/Siddhartha.jpg"
				end
				_test_reader_info(id, thumb)
			end
			...
			def self.tooltip
				info = {
					...
					:summary => "Siddhartha is a novel by Hermann Hesse 
						...
						The reader, Hesse's ninth novel, was written 
						...
						Nepal. In this reader, the Buddha is referred 
						to as \"Gotama\".",
					:users => [
						{
							:id => 1,
			...
			private
			def self._test_reader_info(id, thumb)
				info = {
					:id => id,
					:title => "Test reader",
					...
					:tags => [
						{
							:id => 1,
							:name => "1001 readers you must read before you die",
							:url => "",
							:reader_count => 3435,
							:readers_url => "",
							:like_count => 12413,
					...
					:news => [
						{
							...
							The Smashing Pumpkins bandleader shared concert details by posting on Facereader
							 (via Stereogum). [The] performance will be centered around an ambient/musical 
							 interpretation of [the reader] ... built by modular synthesis, on the fly, he 
							...
							music, one wrote on Facereader. How is that pretentious?",
					...
					:reviews => [
						{
							...
							hedonism. I am not certain if this reader was an attempt to appeal to the Buddhist philosophy, 
							...
							:comments => [
								{
									...
									:comment => "i adore this reader and will always buy it at a used reader store for some i love.",
					...
					:discussions => [
						...
						},
						{
							...
							:comment => "I read this reader for a class in my first year of university and 
							something within the story (the philosophy) touched me very deeply. Perhaps one of 
							the most personally influential readers I've read.",
							:timestamp => "6 years ago",
							:id => 1,
							:url => ""
						},
						{
							...
							:comment => "I could not complete this reader coz of my sister. When I was reading this one 
						...
						},
						{
							...
							:comment => "My boyfriend just finished reading this and said it was the best reader he has 
							ever read.",
							:timestamp => "6 years ago",
							:id => 1,
							:url => ""
						...
						},
						{
							...
							:comment => "this reader is journey to inside and outside of our ",
							:timestamp => "6 years ago",
							:id => 1,
							:url => ""
						},
						{
							...
							:comment => "This reader changed my life and is a must read through different stages of life!",
							:timestamp => "6 years ago",
							:id => 1,
							:url => ""
						},
						{
							...
							:comment => "I don't think I have something to say for this reader. I am just speech less. I felt 
							crying like Govinda after reading the reader, time and again. A life changing reader.",
							:timestamp => "6 years ago",
							:id => 1,
							:url => ""
						},
						{
							...
							:comment => "when you read this reader you realize that there is a big world out there waiting you 
							to experience.",
							:timestamp => "6 years ago",
							:id => 1,
							:url => ""
					...
					:author => {
						...
						he was ready to begin wholeheartedly a new apprenticeship with a readerseller in 
							Tbingen. This experience from his youth he returns to later in his novel, 
							Beneath the Wheel.

						On October 17, 1895, Hesse began working in the readershop Heckenhauer in Tbingen, 
						which had a specialized collection in theology, philology, and law. Hesse's 
						assignment there consisted of organizing, packing, and archiving the readers. 
						After the end of each twelve hour workday, Hesse pursued his own work further, 
						and he spent his long, idle Sundays with readers rather than friends. Hesse 

class Bookmark::Node::ArticleLabel < Bookmark::Node
	...
	def self.get_public
		...
		Bookmark::Node::ArticleLabel.optional_match_user + where_clause + ArticleLabel.return_group(Label.basic_info, Bookmark.basic_info, Bookmark::Node::ArticleLabel.basic_info )  + ", label_count " + ArticleLabel.order_init + " label_count, time DESC " + ArticleLabel.limit(Constant::Count::ArticlesShownInRoom)  
	end

class UsersCommunity < Neo
	...
	def get_info
		@community.match + @community.match_news  +  UsersCommunity.collect_map("news_info" => News.grouped_basic_info) + @user.match + ", community, news_info " + UsersCommunity.optional_match  + ", news_info " + Community.return_group(UsersCommunity.basic_info, "news_info ") 
	end
end
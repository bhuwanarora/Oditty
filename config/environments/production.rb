ReadersDoor::Application.configure do
  ...
  config.nlp_service = "http://nlp.oditty.me/"
  config.google_news_sources = "https://support.google.com/news/answer/40237?hl=en"
  config.blog_url = " https://public-api.wordpress.com/rest/v1.1/sites/readersofindia.wordpress.com/posts/?number=10&pretty=1&order=ASC&fields=title,date,short_URL,excerpt,discussion,like_count,featured_image,tags,is_reblogged,attachments&after="
  ...
  config.image_service = "http://images.oditty.me"
  config.feed_service = "http://feed.oditty.me"

ReadersDoor::Application.configure do
  ...
  config.nlp_service = "http://127.0.0.1:3001/"
  config.google_news_sources = "https://support.google.com/news/answer/40237?hl=en"
  config.blog_url = " https://public-api.wordpress.com/rest/v1.1/sites/readersofindia.wordpress.com/posts/?number=100&pretty=1&order=ASC&fields=title,date,short_URL,excerpt,discussion,like_count,featured_image,tags,is_reblogged,attachments&after="
